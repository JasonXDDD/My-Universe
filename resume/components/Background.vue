...
function createScene() {
  ...
  scene.fog = new THREE.Fog(0x1f3c4a, 100, 950)
...
function loop() {
  land.mesh.rotation.z += 0.005 * 0.5
  orbit.mesh.rotation.z += 0.001 * 0.5
  sky.mesh.rotation.z += 0.003 * 0.5
  forest.mesh.rotation.z += 0.005 * 0.5
  updatePlane()
