<template>
  <section class="rounded-2xl grid grid-cols-4 gap-6">
    ...
    <ItemSummary class="item col-span-2 row-span-2" />
    ...
    <ItemTimeline class="item col-span-2" />
    <ItemSkill class="item col-span-2" />
...
const topics = ref([
  {
    title: '工作經驗',
    from: '',
    to: moment().diff(moment('2016-04-01'), 'years', true).toFixed(2) + '年',
    remark: '2016.04 開始工作',
  },
  { title: '受眾', from: '', to: '10K+', remark: '來自 BottleNeko 受眾' },
